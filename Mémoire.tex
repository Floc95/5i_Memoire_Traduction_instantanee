	...
	\chapter{Résolution du système}\label{system}
		...
		\section{Traduction}\label{traduction}
			...
			\section{Synthèse vocale}\label{synthese}
				...
				\paragraph{}Vient alors la retranscription oral des informations phonétiques (éventuellement accompagné d'informations prosodiques) obtenue via le module de traitement automatique du langage naturel. Cette synthèse se fait en deux étapes
			...
			\section{Émotions}\label{emotions}
				...
				\subsection{Identification des émotions}
					...
					\subsubsection{Comment allons-nous les identifier ?}
						...
						\paragraph{Travaux sur le sujet} 

						\paragraph{Dans le cadre de notre scénario} %% Quel facteurs on choisi et comment techniquement on va faire
				...
				\subsection{Retranscription des émotions}
					...
					\subsubsection{Influence sur la traduction}

						%% Choix des mots et stockage des émotions de base mot à mot

					\subsubsection{Retranscription par synthèse vocale}

						%% Techniquement, comment on fait pour mettre de l'émotion dans une synthèse vocale
