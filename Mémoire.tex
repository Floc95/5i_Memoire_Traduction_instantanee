...
\begin{document}
	...
	\chapter{Références}\label{references}
		...
		\begin{itemize}
			...
			\item \textbf{Computatione Affective: Af?chage, Reconnaissance, et Synthèse par Ordinateur des Émotions} par Marco Paleari (2009) - Utilisation des la partie "Émotions"
