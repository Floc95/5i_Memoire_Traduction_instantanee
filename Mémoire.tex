...
%%NEW STUFF BEGIN					
					...
					\begin{itemize}
							...
							\item \textbf{}Le cadre de notre scénario mène à une faible présence d'émotions poussé à l'extrême 
					\end{itemize}
Notre système devra pouvoir restitué des émotions dans plusieurs langues ce qui implique très probablement que les personnes présentent ne seront pas du même milieu culturel, il est alors préférable que la méthode choisi soit capable de s'adapter à de potentiels différences dans la vocalisation des émotions selon les cultures.  
%%TODO add sources
