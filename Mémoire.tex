...
%% NEW STUFF END					
						...
						\paragraph{}Ici la synthèse se fait via la concaténation d'une série de modèles de Markov caché dépendant du contexte. Ils détermineront la durée et les fondamentales du spectre, puis la forme de l'onde est générée via un filtre dit de "`Mel Log Spectrum Approximation"'.
							\paragraph{}Ce système présente l'avantage d'être capable d'émuler plus finement des émotions en jouant sur des nuances. De plus, en modulant le signal à posteriori il n'est plus nécessaire d'enregistrer la totalité des nuances désirées à l'avance.
